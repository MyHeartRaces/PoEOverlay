 ...
 * @brief Defines the OverlayWindow class for creating and managing the overlay window
 * 
 * This header provides the OverlayWindow class that handles Win32 window creation,
 * desktop composition, click-through capability, multi-monitor support, and input handling.
 */
